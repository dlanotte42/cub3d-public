...
/*   Updated: 2021/03/24 20:30:01 by dlanotte         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_init_struct(t_game *game)
{
	...
	game->player.speed = 0.000030;
	game->textures = malloc(sizeof(t_textures) * 3);
	game->textures[1].texture_path = "./texture/bluestone.xpm";
	game->textures[2].texture_path = "./texture/greystone.xpm";
